            ...
            <div class="session-detail${countdown ? ' next-session' : ''}">
                ...
                <div class="session-title-row">
                    ...
                    <div class="session-title-buttons">
                        <button type="button" class="btn-action checkin-only" onclick="openMediaPicker()" title="Upload photos or videos">
...
async function openMediaPicker() {
    if (window.showOpenFilePicker) {
        try {
            ...
            if (e.name !== 'AbortError') console.error('Media picker error:', e);
        }
    } else {
