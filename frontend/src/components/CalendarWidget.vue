  ...
  <div ref="el" class="w-full bg-dtv-sand p-4">
    ...
    <div class="flex items-center justify-between mb-2 gap-4">
      <button class="w-9 h-9 flex items-center justify-center bg-transparent border-none cursor-pointer text-dtv-dark hover:bg-dtv-green/20" @click="navigateMonth(-1)">
        <img src="/icons/arrows/left.svg" width="16" height="16" alt="Previous month" class="svg-black">
      </button>
      <span class="font-head text-black text-base uppercase tracking-wide">
        {{ formatMonthYear(currentYear, currentMonth) }}
      </span>
      <button class="w-9 h-9 flex items-center justify-center bg-transparent border-none cursor-pointer text-dtv-dark hover:bg-dtv-green/20" @click="navigateMonth(1)">
        <img src="/icons/arrows/right.svg" width="16" height="16" alt="Next month" class="svg-black">
      </button>
    </div>
