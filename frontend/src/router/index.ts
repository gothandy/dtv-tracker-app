...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/sandbox/session-next-action', component: () => import('../pages/sandbox/SandboxSessionNextAction.vue') },
    ...
    { path: '/sandbox/profile-duplicate-warning', component: () => import('../pages/sandbox/SandboxProfileDuplicateWarning.vue') },
    ...
    { path: '/sandbox/personal-prompt', component: () => import('../pages/sandbox/SandboxPersonalPrompt.vue') },
    { path: '/sandbox/personal-contribution', component: () => import('../pages/sandbox/SandboxPersonalContribution.vue') },
